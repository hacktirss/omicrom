...
<html lang="es" xml:lang="es">
    <head>
        ...
        <script type="text/javascript">
            ...
            function alertaG02(url) {
                Swal.fire({
                    title: "¿Desea generar su nota de credito con uso CFDI <br> G02 (Devoluciones, descuentos o bonificaciones)?",
                    background: "#E9E9E9",
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "pagosd33.php" + url + "&UsoCfdi=Si";
                    } else {
                        window.location.href = "pagosd33.php" + url;
                    }
                });
            }
        </script>
    ...
    <body>
                                    ...
                                    <tr style="background-color: #E1E1E1; text-align: center;" class="texto_tablas">
                                        ...
                                        <?php } else { ?>
                                            <?php if ($pagoVO->getStatus_pago() == StatusPagoPrepago::LIBERADO) { ?>
                                                <td style="background-color: #ffdd00">    
                                                    <a href="javascript:confirmar('¿Desea Generar el recibo de anticipo?', '?op=generaAnticipo&busca=<?= $pagoVO->getId() ?>');" title="Generar el Reciboo de Anticipo al cliente de Prepago" class="seleccionar">
                                        ...
                                        <?php } else { ?>    
                                            <?php if ($pagoVO->getStatus_pago() == StatusPagoPrepago::CON_FACTURA_CONSUMOS) { ?>
                                                ...
                                                <td style="background-color: #acecaa">
                                                    ...
                                                    <br>
                                                    <?php
                                                    if ($pagoVO->getSaldoFavor() == 0 && $pagoVO->getImporte() > $FC["total"]) {
        ...
        <script type="text/javascript">
            ...
            } else if (<?= $pagoVO->getStatus_pago() ?> < 4) {
                $(".muestra_complemento").hide();
            }
        </script>
    </body>
