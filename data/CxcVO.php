...
class CxcVO {
    ...
    function getRecibo() {
        return $this->recibo == null ? 0 : $this->recibo;
    }

    function getCorte() {
        return $this->corte == null ? "0" : $this->corte;
    }
    ...
    function getRubro() {
        return $this->rubro == null ? "-----" : $this->rubro;
    }

    function getFactura() {
        return $this->factura == '' ? null : $this->factura;
    }
    ...
    function getClienteDescripcion() {
        return $this->clienteDescripcion;
    }

    function setClienteDescripcion($clienteDescripcion) {
