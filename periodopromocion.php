...
$Titulo = "Periodo de puntos";
$Id = 150;

$paginador = new Paginador($Id,
        "id,tipo_periodo, activo",
        "",
        "",
        "",
    ...
    <body>
        ...
        <div id="TablaDatos">
            <table class="paginador" aria-hidden="true">
                <?php
                echo $paginador->headers(array("Editar"), array("Tipo", "Status"));
                while ($paginador->next()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo $row["tipo_periodo"] == "A" ? "Acumula" : "Bonifica";
                            ?>
                        </td>
                        <td>
                            <?= $row["activo"] == 0 ? "Inactivo" : "Activo"; ?>
                        </td>
                    </tr>
                    <?php
                }
