...
$paginador = new Paginador($Id,
        ...
        IF(cli.tipodepago <> 'Monedero', pagos.uuid, IFNULL(fc.uuid, '-----')) uuid",
        "LEFT JOIN cli ON pagos.cliente = cli.id 
        LEFT JOIN fc ON pagos.id = fc.relacioncfdi AND fc.status = " . StatusFactura::CERRADO,
        "",
        "",
...
<html lang="es" xml:lang="es">
    ...
    <body>
            ...
            <table class="paginador" aria-hidden="true">
                ...
                while ($paginador->next()) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <?php if ($row["tipodepago"] === TiposCliente::PREPAGO || $row["tipodepago"] === TiposCliente::CREDITO) { ?>
        ...
        "<i class=\"icon fa fa-lg fa-plus-circle\" aria-hidden=\"true\"></i> ExportarXFecha" => "javascript:wingral('pidedatos.php?criteria=ini&busca=7')");
