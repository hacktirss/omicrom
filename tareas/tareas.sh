...
args_mysql="-h localhost -u appuser -pdet15a omicrom -se";

echo "Tasks of mysql"
echo "***********************************************"
echo "***********************************************"

echo "Insert into v_tanques_h"
mysql $args_mysql "
