...
$Titulo = "Bonificaciones a clientes";
$Id = 89;
...
$paginador = new Paginador($Id,
        ...
        "",
        "",
        "p.cliente = cli.id AND p.producto = inv.id",
    ...
    <body>
        ...
        <div id="TablaDatos">
            <table class="paginador" aria-hidden="true">
                <?php
                echo $paginador->headers(array("Acuse"), array());
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <?php if ($row["status"] == "Cerrada") { ?>
                                <a href=javascript:wingral("pdfbonificacion.php?busca=<?= $row["id"] ?>")><i class="icon fa fa-lg fa-print" aria-hidden="true"></i></a>
                                <?php } ?>
                        </td>
        ...
        <?php
        echo $paginador->footer($usuarioSesion->getLevel() >= 7, array("V2" => "bonificacionMonederos.php?criteria=ini"));
