                 ...
                 <table aria-hidden="true">
                            ...
                            if ($cPrd <> $rg["producto"]) {
                                if (!empty($cPrd)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="numero"><?= number_format($nImpNor + $nImpCon, 2) ?></td>
                                    </tr>
                                    <?php
                                }
                                ...
                                $nVts = $nImpNor = $nImpCon = $nLtsNor = $nLtsCon = 0;
                            }

                            if ($rg["tipo"] == "N") {   //Consignacion
                                $nImpCon += $rg["pesos"];
                                $nLtsCon += $rg["volumen"];
                                $nVts += $rg["ventas"];
                            } elseif ($rg["tipo"] == "D") {
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td class="moneda"><?= number_format($nImpNorT + $nImpConT, 2) ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
