...
(function($) {
     ...
     $.ttwNotificationMenu = function(userOptions) {
        ...
        defaults = {
            ...
            notificationListEmptyText:'Sin Notificaciones',
        ...
        function existsNotification(notification){
            var notiticationUnread = notifications[notification.category].unread;
            var response = false;
            $.each(notiticationUnread, function (i, obj) {
                if(notification.id === obj.id){
                    response = true;
                    return;
                }
            });
        ...
        NotificationList = function(notificationListOptions) {
            ...
            this.markup = {
                ...
                notificationListMenu:'<ul class="notification-list-menu">' +
                        ...
                        '<li id="all-menu-item" class="notification-list-menu-item">Todas</li>' +
        ...
        Notification.prototype.initCategory = function(){
            notifications[this.category] = {};

            notifications[this.category].count = 0;
            notifications[this.category].readCount = 0;
            notifications[this.category].unreadCount = 0;

            notifications[this.category].read = {};        //create an empty notifications array for the category
            notifications[this.category].unread = {};        //create an empty notifications array for the category
        };
        ...
        notificationMenu.createNotification = function(notificationOptions) {
            ...
            if (notification.create()) {
                if(!existsNotification(notification)){
