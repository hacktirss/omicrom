        ...
        <form name='form1' method='post' action="">
            <table class="cxcOpciones" aria-hidden="true">
                <tr class='texto_tablas'>
                    ...
                    <td><input class='nombre_cliente' type='submit'  name='Boton' value='Enviar'></td>
                    <td align='center'>
                        &nbsp; <input type='radio' name='orden' value='referencia' <?= $cRef ?> onChange=submit();> Referencia 
                        &nbsp; <input type='radio' name='orden' value='factura' <?= $cFac ?> onChange=submit();> Factura 
                        &nbsp; <input type='radio' name='orden' value='fecha' <?= $cFec ?> onChange=submit(); > Fecha
                    </td>
                </tr>
            </table>
