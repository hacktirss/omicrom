...
var fileAjax = "bootstrap/ajax/getMangueras.php";
var paramValidator = "Mangueras";
var modalAdd = "";
var modalEdit = "#modal-mangueras";
var modalOperation = "#modal-mangueras-operaciones";
var modalListas = "#modal-mangueras-listas";


$("body").on("shown.bs.modal", modalEdit, function (e) {
    var event = $(e.relatedTarget);
    var Identificador = event.data("identificador");
    var modalTitle = "Mangueras del sistema";
...
function setValueFromList(control, value) {
    if (control === "CLAVES_SISTEMAS_MEDICION") {
        $("#Tipo_medidor").val(value);
    }    
